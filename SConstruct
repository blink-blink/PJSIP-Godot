...
#pjsua2 library
env.Append(CPPPATH=['D:\Documents\GodotGames\pjproject-2.12.1\pjlib\include'])
env.Append(CPPPATH=['D:\Documents\GodotGames\pjproject-2.12.1\pjlib-util\include'])
env.Append(CPPPATH=['D:\Documents\GodotGames\pjproject-2.12.1\pjnath\include'])
env.Append(CPPPATH=['D:\Documents\GodotGames\pjproject-2.12.1\pjmedia\include'])
env.Append(CPPPATH=['D:\Documents\GodotGames\pjproject-2.12.1\pjsip\include'])
